...
\begin{DoxyCompactList}\small\item\em Length of input buffer used when scanning the keyboard. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Typedefs}
\begin{DoxyCompactItemize}
\item 
...
Length of input buffer used when scanning the keyboard. 
